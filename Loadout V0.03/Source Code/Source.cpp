...
// Version 0.03                                                   //
////////////////////////////////////////////////////////////////////
// Third attempt at creating a save editing UI for Nuclear Throne //
// This Third prototype still has a totally text based UI         //
// It allows for the user to make multiple edits to characters	  //
// Version 0.03 adds crown adding for characters				  //							  
////////////////////////////////////////////////////////////////////
...
void editCrown(ifstream, ostream, string);
void editValue(ifstream, ostream, string);
...
void editCrown(ifstream &reader, ofstream &newSave, string name) { // Works very similarly to editValue
	...
	std::size_t finder; // This finds the first "crowns" value in the string
...
void editValue(ifstream &reader, ofstream &newSave, string name) {
	cout << "Enter 1 for crowns. Enter anything else to go to weapons.\n";
	string crown;
	cin >> crown;
	cin.ignore(); // skips enter input
	size_t finder;
	finder = crown.find("1");
	if (finder != std::string::npos && crown.length() == 1) {
